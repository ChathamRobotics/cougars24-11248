    ...
    // "My Pizza Crystalized" - Chip
        ...
        public void runOpMode() {
            ...
            while (opModeIsActive()) {
                // if you're reading this Chris, you're mega gay.
                ...
                if (gamepad2.dpad_down) {robot.pivot.setState(0.6f); robot.pivottwo.setState(0.6f);  Thread delayThread = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        try {
                            Thread.sleep(1000); // Adjust the delay time in milliseconds
                        } catch (InterruptedException e) {
                            // Handle InterruptedException if needed
                            e.printStackTrace();
                            {robot.pivot.setState(1f); robot.pivottwo.setState(1f);}
